...
async function main() {
  ...
  })`), { stayedStill: true, timerAdvanced: true, orderExpired: true, cookingPhase: "ready", recovering: true }, "round time, order expiry, cooking, and recovery continue while controls are locked");
  ...
  }, "solo timer reaching zero closes an active challenge and stops the round immediately");
  await sleep(750);
